...
class ofdmframe_gen(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "OFDM Frame Generation", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("OFDM Frame Generation")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "ofdmframe_gen")
        ...
        self.connect((self.digital_ofdm_tx_0, 0), (self.blocks_stream_to_vector_0, 0))
...
def main(top_block_cls=ofdmframe_gen, options=None):
